package com.yp.manage.sercurity.config;

import com.yp.manage.sercurity.UserDetailsServiceImpl;
import com.yp.manage.sercurity.code.img.ImageCodeFilter;
import com.yp.manage.sercurity.filter.PreJwtAuthenticationTokenFilter;
import com.yp.manage.sercurity.handle.PreAccessDeineHandler;
import com.yp.manage.sercurity.handle.PreAuthenticationEntryPointImpl;
import com.yp.manage.sercurity.handle.PreAuthenticationFailureHandler;
...
public class PreWebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/login/**","/auth/**","/register/**").anonymous()
